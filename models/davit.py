...
class WindowAttention(nn.Module):
    ...
    def forward(self, x):
        B_, N, C = x.shape
        # print(x.shape)
        # print(self.qkv(x).reshape(B_, N, 3, self.num_heads, C // self.num_heads).shape)
...
class DaViT(nn.Module):
    ...
    # patch_size=4, window_size=7, embed_dims=(128, 256, 512, 1024), num_heads=(4, 8, 16, 32),
        ...
        # original davit embed_dims=(64, 128, 192, 256)

    def __init__(self, in_chans=3, num_classes=1, depths=(1, 1, 9, 1), patch_size=4,
                 embed_dims=(64, 128, 192, 256), num_heads=(3, 6, 12, 24), window_size=8, mlp_ratio=4.,
