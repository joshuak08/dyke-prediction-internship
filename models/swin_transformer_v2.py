...
class SwinTransformerBlock(nn.Module):
    ...
    def forward(self, x):
        H, W = self.input_resolution
        B, L, C = x.shape
        # print('input res before swin transformer block',self.input_resolution)
        # print('x.shape before swin transformer block', x.shape)
        ...
        # print('x.shape after swin transformer block', x.shape)
        return x
...
class PatchMerging(nn.Module):
    ...
    def forward(self, x):
        ...
        x: B, H*W, C
        """
        # print('before patch merging', x.shape)
        H, W = self.input_resolution
        B, L, C = x.shape
        assert L == H * W, "input feature has wrong size"
...
class BasicLayer(nn.Module):
    ...
    def forward(self, x):
        # print('before basic layer', x.shape)
        ...
        if self.downsample is not None:
            x = self.downsample(x)
        # print('after basic layer', x.shape)
        return x
